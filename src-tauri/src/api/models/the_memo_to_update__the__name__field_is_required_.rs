...
pub struct TheMemoToUpdateTheNameFieldIsRequired {
    ...
    pub location: Option<Box<models::Apiv1Location>>,
}

impl TheMemoToUpdateTheNameFieldIsRequired {
    pub fn new() -> TheMemoToUpdateTheNameFieldIsRequired {
